...
class VICRTPlanAutoDicom(PythonImageFileAutoDicom):
    description = "VIC RT plan format"
    @property
    ...
    def fraction_group_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanFractionGroupAutoDicom(s) for s in val]
    @property
    def patient_setup_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanPatientSetupAutoDicom(s) for s in val]
    @property
    def referenced_rt_plan_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanReferencedRTPlanAutoDicom(s) for s in val]
    @property
    def beam_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanBeamAutoDicom(s) for s in val]
    @property
    def tolerance_table_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanToleranceTableAutoDicom(s) for s in val]
    @property
    def referenced_structure_set_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanReferencedStructureSetAutoDicom(s) for s in val]
    @property
    def dose_reference_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanDoseReferenceAutoDicom(s) for s in val]
...
class VICRTPlanFractionGroupAutoDicom(PythonAutoDicom):
    ...
    def referenced_beam_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanReferencedBeamAutoDicom(s) for s in val]
...
class VICRTPlanReferencedBeamAutoDicom(PythonAutoDicom):
    ...
    @property
    def beam_dose_specification_point(self):
        if (0x300a,0x0082) in self._pydicom_obj:
            if (isinstance(self._pydicom_obj[0x300a,0x0082].value, BaseTag)):
                return self._pydicom_obj[0x300a,0x0082].value
            elif (isinstance(self._pydicom_obj[0x300a,0x0082].value, MultiValue)):
                return [float(s) for s in self._pydicom_obj[0x300a,0x0082].value]
            else:
                return float(self._pydicom_obj[0x300a,0x0082].value)
        else:
            return None
    ...
    def __str__(self):
        ...
        to_ret_str += 'beam_dose_specification_point: %s\n'%(self.beam_dose_specification_point)
...
class VICRTPlanReferencedRTPlanAutoDicom(PythonAutoDicom):
    description = "AutoDicom inner class of VICRTPlanAutoDicom"
    @property
    ...
    @property
    def rt_plan_relationship(self):
        if (0x300a,0x0055) in self._pydicom_obj:
            if (isinstance(self._pydicom_obj[0x300a,0x0055].value, BaseTag)):
                return self._pydicom_obj[0x300a,0x0055].value
            elif (isinstance(self._pydicom_obj[0x300a,0x0055].value, MultiValue)):
                return [s for s in self._pydicom_obj[0x300a,0x0055].value]
            else:
                return self._pydicom_obj[0x300a,0x0055].value
        else:
            return None
    ...
    def __str__(self):
        ...
        to_ret_str += 'rt_plan_relationship: %s\n'%(self.rt_plan_relationship)
...
class VICRTPlanBeamAutoDicom(PythonAutoDicom):
    ...
    @property
    def highdose_technique_type(self):
        if (0x300a,0x00c7) in self._pydicom_obj:
            if (isinstance(self._pydicom_obj[0x300a,0x00c7].value, BaseTag)):
                return self._pydicom_obj[0x300a,0x00c7].value
            elif (isinstance(self._pydicom_obj[0x300a,0x00c7].value, MultiValue)):
                return [s for s in self._pydicom_obj[0x300a,0x00c7].value]
            else:
                return self._pydicom_obj[0x300a,0x00c7].value
        else:
            return None
    ...
    def control_point_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanControlPointAutoDicom(s) for s in val]
    @property
    def primary_fluence_mode_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanPrimaryFluenceModeAutoDicom(s) for s in val]
    @property
    def beam_limiting_device_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanBeamLimitingDeviceAutoDicom(s) for s in val]
    ...
    def __str__(self):
        ...
        to_ret_str += 'manufacturer: %s\n'%(self.manufacturer)
        to_ret_str += 'highdose_technique_type: %s\n'%(self.highdose_technique_type)
        to_ret_str += 'private_creator: %s\n'%(self.private_creator)
...
class VICRTPlanControlPointAutoDicom(PythonAutoDicom):
    ...
    def beam_limiting_device_position_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanBeamLimitingDevicePositionAutoDicom(s) for s in val]
    @property
    def referenced_dose_reference_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanReferencedDoseReferenceAutoDicom(s) for s in val]
...
class VICRTPlanToleranceTableAutoDicom(PythonAutoDicom):
    ...
    def beam_limiting_device_tolerance_sequence(self):
        ...
        if val=='None' or val is None:
            ...
            return [VICRTPlanBeamLimitingDeviceToleranceAutoDicom(s) for s in val]
